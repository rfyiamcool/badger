...
* [raft-badger](https://github.com/rfyiamcool/raft-badger) - raft-badger implements LogStore and StableStore Interface of hashicorp/raft. it is used to store raft log and metadata of hashicorp/raft.
